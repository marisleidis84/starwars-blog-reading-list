    ...
    <nav className="navbar fixed-top navbar-expand-lg navbar-dark fixed-top">
      <div className="container">
        ...
        <div className="dropdown">
          <button className="btn dropdown-toggle " type="button" data-toggle="dropdown" style={{ 'width': '200px', 'backgroundColor':'#ed8b2f' }}>Favorites  <span class="badge bg-secondary">0</span></button>
